							...
							<table key="item.id" className="productos">
								...
								{item.cantidad > 1 ? (
									<tr>
										...
										<td>
											<h3 class="finalTicket">${item.totalArticulo}</h3>
										</td>
									</tr>
								) : null}
							</table>
